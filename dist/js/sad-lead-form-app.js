...
var SadLeadFormTemplate =
/*#__PURE__*/
function () {
  function SadLeadFormTemplate(rgpdDescription) {
...
function () {
  ...
  _createClass(SadLeadFormModel, [{
    ...
    value: function _extractObject() {
      ...
      formDataAsObject.needs = Array.from(this._elements.extraFields.needs).filter(function (checkbox) {
    ...
    value: function _validateMeanOfCommunication() {
      if (!this._elements.toggle.email.checked && !this._elements.toggle.address.checked && !this._elements.toggle.phone.checked) {
